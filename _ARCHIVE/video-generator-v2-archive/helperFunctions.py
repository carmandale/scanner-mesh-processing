...
def getRemoteProcess(macName):
    processUrl = "{0}/{1}?machineName={2}".format(DATA["awsBackend"]["baseUrl"], DATA["awsBackend"]["getProcessRoute"], macName)
...
def sendPlayerVideo(processId, videoPath, imagePreviewPath, player="singleplayer"):
    ...
    files = {
        ...
        "imageValidation": (f"{processId}.png", open(imagePreviewPath, 'rb'))
    }
