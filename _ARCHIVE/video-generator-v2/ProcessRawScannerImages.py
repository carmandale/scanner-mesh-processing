...
def movieMakerCommandMP(blenderPath, blendFilePath, blendPyPath, p1CaptureId, p2CaptureId, jump, winner, scanPath="/System/Volumes/Data/mnt/scanDrive2/takes/"):
    """
        Function that generates a generic commandLine blender command command.
        Applications/Blender.app/Contents/MacOS/Blender -b /Users/groovejones/Software/12.18.22/retargeting/multiplayer/sh0200_MultiPlayer_Moviemaker.blend -P /Users/groovejones/Software/12.18.22/retargeting/multiplayer/multiplayer_moviemaker.py -- -p0 3a081f97-b2df-ff2f-c8d1-1810729498a0 -p1 3a0848e0-e48c-eb1e-3d6f-678466a5c33f -m /Users/groovejones/LocalSboxStore --jump_count 0 --winner_index 0
    """
    return f"{blenderPath} -b {blendFilePath} -P {blendPyPath} -- -p0 {p1CaptureId} -p1 {p2CaptureId} -m {scanPath} --jump_count {jump} --winner_index {winner}"
