...
echo "-------------------------"
echo "-------------------------"
# echo /Applications/Blender.app/Contents/MacOS/Blender -b /Volumes/scanDrive/software/5.2.22/movieMaker.blend -P /Volumes/scanDrive/software/5.2.22/movieMaker.py -- --scan $1
 /Volumes/scanDrive/software/5.2.22/movieMaker.SF.blend -P /Volumes/scanDrive/software/5.2.22/movieMaker.py -- --scan $1 --path /Volumes/scanDrive/takes/
