...
# usage blender -b blender_filepath -P pose_test_filepath -- --scan SCAN_ID --path SCAN_DIRECTORY --software SOFTWARE_DIRECTORY
...
def main():
    ...
    pose_test_rig_filename = "pose_test_rig.blend"
