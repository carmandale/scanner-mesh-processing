...
def main():
    print_decorated(f"Executing the main() function in {script_name}.py...")
    ...
    OBJ = import_usda_model(USDC_PATH)
    ...
    if OBJ:
        ...
        object_parent_clear(OBJ)
        object_apply_transforms(OBJ)
        select_highest_vertices(OBJ, 0.1)
