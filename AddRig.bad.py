...
if __name__ == '__main__':
    ...
    keypoints_file_path = os.path.join(path ,str(scan),"photogrammetry")
    # Name of the keypoints file
    keypoints_file_name = str(scan) + '_results.txt'
    ...
    directory=os.path.join(os.path.join(obj_file_path, obj_file_name,"Collection/")),
                filename="geo")
